    ...
    <div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            ...
            if(is_array($formdata['0']))
                ...
                <?php }?>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">场景/举报分类</label>
                <div class="col-lg-3 col-sm-4 col-xs-4 input-group"><?php echo $r['cjfl'];?></div></div>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">图片/文件</label>
                <div class="col-lg-3 col-sm-4 col-xs-4 input-group"><a href="<?php echo $r['url'];?> "><img src="<?php echo $r['url'];?> " alt=""></a></div></div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2 col-xs-4 control-label">
                    <input type="text" class="form-control" name="reply_user" disabled="disabled" placeholder="<?php echo $reply_user;?>">
                </div>
            </div>
            <div class="form-group">
